...
searchDirectoryFiles(getcwd() . '/', 'package-test', $argv[1]);

searchDirectoryFiles(getcwd() . '/', 'PackageTest', dashesToCamelCase($argv[1], true));

searchDirectoryFiles(getcwd() . '/', 'Package Test', dashesToCamelCase($argv[1], true, ' '));
